...
export function defaultTenders() {
  return [
    { id: 0, type: 'tender', title: 'Supply of office IT infrastructure — HQ Ship House', ref_number: 'MOD/2026/IT/01', category: 'Supplies', method: 'Open Tender · National Competitive Bidding', closes_at: '2026-06-12', doc_url: '', description: '', sort_order: 0, active: 1 },
    { id: 0, type: 'tender', title: 'Renovation of Ship House conference rooms', ref_number: 'MOD/2026/WK/04', category: 'Works', method: 'Open Tender · Works', closes_at: '2026-06-28', doc_url: '', description: '', sort_order: 1, active: 1 },
    { id: 0, type: 'tender', title: 'Vehicle fleet maintenance services (3-year framework)', ref_number: 'MOD/2026/SV/07', category: 'Services', method: 'EOI · Services', closes_at: '2026-07-05', doc_url: '', description: '', sort_order: 2, active: 1 },
    { id: 0, type: 'tender', title: 'Defence-industrial advisory & feasibility study', ref_number: 'MOD/2026/CN/02', category: 'Consultancy', method: 'Restricted · Consultancy', closes_at: '2026-07-19', doc_url: '', description: '', sort_order: 3, active: 1 },
    { id: 0, type: 'award', title: 'Medical equipment for military hospitals', ref_number: 'MOD/2026/AW/01', category: 'Supplies', method: 'National Competitive Bidding', closes_at: null, doc_url: '', description: 'Awarded after evaluation by the Ministerial Tenders Board.', sort_order: 0, active: 1 },
    { id: 0, type: 'award', title: 'NAFRC training equipment, batch 2026A', ref_number: 'MOD/2026/AW/02', category: 'Supplies', method: 'Open Tender', closes_at: null, doc_url: '', description: 'Awarded for delivery to the Resettlement Centre, Oshodi.', sort_order: 1, active: 1 },
  ];
}
