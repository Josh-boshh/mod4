...
export function renderLoginPage({ error, csrf, email = '' }) {
  return pageShell({
    title: 'Admin Login — FMOD Website',
...
export function renderSetupPage({ errors = [], success = null, csrf }) {
  ...
  return pageShell({
    title: 'Admin Setup — FMOD Website',
    bodyClass: '',
      ...
      <div class="panel" id="procurement-edit-panel">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="form-row">
            ...
            <label>Reference number<input type="text" name="tender_ref" value="${escapeHtml(editTender?.ref_number ?? '')}" placeholder="e.g. FMOD/2026/IT/01" /></label>
          </div>
          <div class="form-row">
  ...
  <main class="admin-main">
    <div class="admin-topbar">
      <div class="topbar-left">
        ...
        <div class="topbar-breadcrumb"><span>Federal Ministry of Defence</span><span class="sep">›</span><span class="current" id="topbar-current">Dashboard</span></div>
      </div>
    </div>
...
(function () {
  ...
  return pageShell({
    title: 'Admin Dashboard — FMOD Website',
    bodyClass: 'admin-body',
